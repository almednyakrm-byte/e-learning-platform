...
<body class="bg-slate-900 text-white">
    ...
    <main class="container mx-auto p-4 pt-6 md:p-6 lg:p-12 xl:p-24">
        ...
        <div class="flex justify-between mb-4">
            <button class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded" onclick="location.href='create_مقررات.php'">Add New Item</button>
            ...
            .then(data => {
                ...
                data.forEach(record => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="px-4 py-2">
                            <a href="edit_مقررات.php?id=${record.id}" class="text-indigo-500 hover:text-indigo-700">Edit</a>
